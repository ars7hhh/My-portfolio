    ...
    >
      <nav
        className={`max-w-6xl mx-auto px-6 md:px-10 h-16 flex items-center justify-between transition-all duration-300 ${
          scrolled ? "glass rounded-full mx-4 md:mx-auto md:max-w-5xl" : "bg-transparent"
        }`}
      >
        <a href="#intro" className="font-display font-semibold text-ink text-lg tracking-tight">
