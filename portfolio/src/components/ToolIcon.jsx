import snapseed from "../assets/tools/snapseed.png";
import capcut from "../assets/tools/capcut.png";
import vnLogo from "../assets/tools/vn.png";
export default function ToolIcon({ name, size = 22 }) {
  const common = { width: size, height: size, viewBox: "0 0 24 24" };

  switch (name) {
    case "picsart":
      // Official Picsart logo mark
      return (
    ...
    case "capcut":
      return <img src={capcut} alt="CapCut" width={size} height={size} className="object-contain rounded-full" />;

    case "snapseed":
      return <img src={snapseed} alt="Snapseed" width={size} height={size} className="object-contain rounded-full" />;

    case "vn":
      return <img src={vnLogo} alt="VN Video Editor" width={size} height={size} className="object-contain rounded-full" />;
